    ...
    static async readLine(filename) {
        try {
            ...
            for await (const line of rl) {
                ...
                await GPTOutputParser.writeStringToFile(content, '/Users/shubham_sharma/IdeaProjects/ub-hacking-create-your-repo-here-mac-p/website/backend/uploads/output.txt');
            }
        } catch (error) {
